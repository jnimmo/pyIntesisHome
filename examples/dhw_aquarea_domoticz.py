...
def aquarea_to_domoticz(
    ...
    if mode == "tank" or power == "off":
        msgs = [
            {
                "topic": "domoticz/in",
                "payload": '{"idx":%d,"nvalue":0,"svalue":"%s"}'
                % (temp_idx, str(tank_temp)),
            },
            (
                "domoticz/in",
                '{"idx":%d,"nvalue":0,"svalue":"%s"}'
                % (tank_set_point_idx, str(tank_set_point)),
                0,
                False,
            ),
            (
                "domoticz/in",
                '{"idx":%d,"nvalue":0,"svalue":"%s"}'
                % (ext_temp_idx, str(outdoor_temp)),
                0,
                False,
            ),
            (
                "domoticz/in",
                '{"idx":%d,"nvalue":%d}' % (power_idx, 1 if power == "on" else 0),
                0,
                False,
            ),
        ]
    elif power == "on" and (
        mode == "heat" or mode == "heat+tank" or mode == "cool+tank" or mode == "cool"
    ):
        if mode == "heat" or mode == "heat+tank":
            msgs = [
                ...
                (
                    "domoticz/in",
                    '{"idx":%d,"nvalue":0,"svalue":"%s"}'
                    % (water_set_point_idx, str(water_target_temp)),
                    0,
                    False,
                ),
                (
                ...
                (
                    "domoticz/in",
                    '{"idx":%d,"nvalue":0,"svalue":"%s"}'
                    % (out_temp_idx, str(water_outlet_temp)),
                    0,
                    False,
                ),
                (
                ...
                (
                    "domoticz/in",
                    '{"idx":%d,"nvalue":0,"svalue":"%s"}'
                    % (in_temp_idx, str(water_inlet_temp)),
                    0,
                    False,
                ),
            ]
            ...
            msgs = [
                ...
                (
                    "domoticz/in",
                    '{"idx":%d,"nvalue":0,"svalue":"%s"}'
                    % (water_set_point_idx, str(cool_setpoint)),
                    0,
                    False,
                ),
                (
